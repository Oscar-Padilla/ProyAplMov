...
const CreacionMateria1 = ({navigation}) => {
  ...
  return (
    <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          <TouchableOpacity onPress={() => navigation.goBack("CreacionMateria")} style={styles.closeButton}>
              <Image source={left} style={styles.closeText} />
          </TouchableOpacity>
          <Text style={styles.title}>Materia</Text>
          <View style={styles.forms}>
            <Text style={styles.correoText}>¿Qué grupo es?</Text>
            <TextInput 
          ...
          <View style={styles.bottomThing}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("CreacionMateria2")} style={styles.btnNext} >
...
export default CreacionMateria1;