...
const CrearMateria5 = ({ navigation, route }) => {
    ...
    const elegirImagen = async () => {
        ...
        if (!resultado.canceled) {
            ...
            const nombreArchivo = `materia_${Date.now()}.jpg`;
    ...
    const subirImagenYGuardarMateria = async () => {
        try {
            const nuevaId = await generarIdMateria();
            const materiaRef = doc(db, 'materias', nuevaId);

            await setDoc(materiaRef, {
                nombre: route.params?.materiaNombre,
                grupo: route.params?.grupo,
                creditos: route.params?.creditos,
                horario: route.params?.horarios,
            ...
            alert(`Materia guardada como ${nuevaId} ✅`);
        } catch (error) {
        ...
        <View style={styles.overlay}>
            <View style={styles.modalContainer}>
                ...
                <View style={styles.bottomThing}>
                    ...
                    <TouchableOpacity onPress={subirImagenYGuardarMateria} style={styles.btnNext}>
                        <Text style={styles.text}>Guardar Materia</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
