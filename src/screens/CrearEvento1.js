...
const CrearEvento1 = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.overlay}>
            <View style={styles.modalContainer}>
                <TouchableOpacity onPress={() => navigation.navigate("CrearEvento")} style={styles.closeButton}>
                    <Image source={left} style={styles.closeText} />
                </TouchableOpacity>
                <Text style={styles.title}>Evento</Text>
                <View style={styles.forms}>
                    <Text style={styles.correoText}>Breve descripción</Text>
                    <TextInput
                        style={[styles.inputCorreo, { textAlignVertical: 'top' }]}
                        ...
                        numberOfLines={4}
                    />
                    <Text style={{fontSize: 16, color: '#A5A5A5'}}>{maxCaracteres - text.length} caracteres restantes</Text>
                </View>
                <View style={styles.bottomThing}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("CrearEvento2", {
