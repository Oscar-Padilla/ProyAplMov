    ...
    <View style={styles.overlay}>
      <View style={styles.modalContainer}>
        ...
        <View style={styles.forms}>
          <Text style={styles.correoText}>¿Cuál es el nombre del evento?</Text>
          <TextInput
        ...
        <View style={styles.bottomThing}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("CrearEvento1", {eventoNombre: text})} style={styles.btnNext} >
