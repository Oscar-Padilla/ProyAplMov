...
const CrearMateria1 = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.overlay}>
            <View style={styles.modalContainer}>
                <TouchableOpacity onPress={() => navigation.navigate("CrearMateria")} style={styles.closeButton}>
                ...
                <View style={styles.bottomThing}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("CrearMateria2", {
